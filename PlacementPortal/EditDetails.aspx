<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditDetails.aspx.cs" Inherits="PlacementPortal.EditDetails" %>
...
<body>
    <form id="form1" runat="server">
        <div class="form-main">
            ...
            <div class="form-content ed">
                <div class="content-box ac">
                    <div class="content-box-main">
                        <asp:Label ID="lblRegNo" runat="server" Text="Registration No:" CssClass="lbl-gen"></asp:Label><br />
                        <asp:Label ID="lblRN" runat="server" CssClass="tb-gen"></asp:Label><br />
                        ...
                        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Save Details" CssClass="btn-home sub"/><br />
                    </div>
                </div>
            </div>
        </div>
